    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(array('route' => ['gallery.update',$gallery->id],'class'=>'row','id'=>'add-gallery', 'files' => 'true')) !!}
                ...
                <div class="container">
                    <div class="form-group row {{ $errors->has('title') ? 'has-errors' : '' }}">
                        ...
                        <div class="col-lg-10">
                            ...
                            {!! Form::text('title', $gallery->title, array('class'=>'form-control','placeholder'=>'Gallery title' )) !!}
                            @if($errors->has('title'))
                    ...
                    <div class="form-group row {{$errors->has('image') ? 'has-errors' : ''}}">
                        ...
                        <div class="col-lg-10">
                            @if(file_exists('storage/'.$gallery->image) && $gallery->image !== '')
                                <img src="{{asset('storage/'.$gallery->image)}}" alt="{{asset('storage/'.$gallery->image)}}" class="displayimage" style="width:100px; height:100px">
                            @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            {!! Form::textarea('description', $gallery->description, array('class'=>'form-control editor', 'placeholder'=>'Please insert the description','id'=>'editor', 'required' => 'true')) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <div class="make-switch ">
                                {!! Form::checkbox('is_active', 1, $gallery->is_active, array('class' => 'switch','data-on-text'=>'On','data-off'=>'Off', 'data-on-color'=>'success','data-off-color'=>'danger' )) !!}
