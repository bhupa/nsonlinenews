                        ...
                        <div class="form-group row {{ $errors->has('is_active') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-9">
                                ...
                                <label class="radio radio-inline m-r-20">
                                    <input type="radio" name="is_active" value="1"  @if($category->is_active=='1')checked="checked" @endif>
                                    <i class="input-helper"></i>
                                    Yes
                                </label>
                                <label class="radio radio-inline m-r-20">
                                    <input type="radio" name="is_active" value="0" @if($category->is_active=='0')checked="checked" @endif>
                                    <i class="input-helper"></i>
                                    No
                                </label>
                                @if ($errors->has('slug'))
