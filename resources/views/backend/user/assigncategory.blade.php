...
@section('title','Assign Cateegory')
@section('css_scripts')
    <style>
        /*.dropdown {*/
        /*position: absolute;*/
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($user->can('delete-role'))
                                    <a href="#"  id="{{ $category->category_id }}" data-type="{{$category->user_id }}" title="{{ trans('labels.admin.user.delete')}}"
                ...
                <form action="{{ route('user.storer.category',[$users->id]) }}" method="post" class="row" role="form"
                                ...
                                <dl class="dropdown">
                                    ...
                                    <dt>
                                        <a href="#">
                                            ...
                                            <input type="hidden" class="role" name="category_id" value="">
                                            <p class="multiSel"></p>
                                        </a>
                                    </dt>
                                        ...
                                        <div class="mutliSelect">
                                            <ul>
                                                ...
                                                @foreach($categories as $category)
                                                    ...
                                                    <li>
                                                        {!! Form::checkbox('is_active',$category->name,0,array('class' => 'checkbox', 'id'=>$category->id,)) !!}
...
//
                swal({
                    ...
                    $.ajax({
                        ...
                        data: {category_id: $object.id,user_id:user_id, _token: '{!! csrf_token() !!}'},
