    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(array('route' => 'advertise.store','class'=>'row','id'=>'add-advertisement', 'files' => 'true','enctype'=>'multipart/form-data')) !!}
                ...
                <div class="container">
                    <div class="form-group row {{ $errors->has('title') ? 'has-errors' : '' }}">
                        ...
                        <div class="col-lg-10">
                            ...
                            {!! Form::text('title', null, array('class'=>'form-control','placeholder'=>'Advertising title' )) !!}
                            @if($errors->has('title'))
        ...
        @section('js_script')
            ...
            $('#single-image').on('click','#addcancle',function(){
                debugger
                $('#single-img').remove();
                $('#addcancle').remove();
                $(".home-fileimage").val('');
