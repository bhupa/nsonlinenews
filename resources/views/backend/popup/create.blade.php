@extends('backend.app')
@section('title',trans('labels.admin.popup.add'))
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(array('route' => 'popup.store','class'=>'row','id'=>'add-gallery', 'files' => 'true')) !!}

                <legend class="text-uppercase font-size-sm font-weight-bold">{{ trans('labels.admin.popup.add') }}</legend>
                <div class="container">
                    <div class="form-group row {{ $errors->has('title') ? 'has-errors' : '' }}">
                        ...
                        <div class="col-lg-10">
                            ...
                            {!! Form::text('title', null, array('class'=>'form-control','placeholder'=>'Popup title' )) !!}
                            @if($errors->has('title'))
                            ...
                            if (input.files && input.files[0]) {
                                ...
                                reader.onload = function(e) {
                                    ...
                                    $('.use').on('click', function() {
                                        resize.result({type: 'canvas', size: { width:600,height:600}}).then(function(dataImg) {
